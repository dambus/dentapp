-- Harden payment recording currency validation after initial RPC migration.
-- The RPC must not silently normalize invalid currency input; it should enforce
-- the same uppercase three-letter representation as the schema.
